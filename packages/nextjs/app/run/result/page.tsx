          ...
          <div className="flex items-center gap-3 flex-wrap">
            <div className="relative">
              ...
              {postureDropdownOpen && (
                <>
                  ...
                  <ul className="absolute left-0 top-full z-20 mt-1 min-w-[200px] rounded-md border border-slate-200 bg-white py-1 shadow-lg" role="listbox">
            ...
            {canSwitchProvider && (
              <RunWithDifferentAIButton
                result={result}
                onRerun={(newRunId) => router.push(`/run/result?run_id=${newRunId}`)}
              />
            )}
            <Link
